        ...
        <div className="max-w-screen-xl mx-auto xl:px-10">
          ...
          <div className="mt-20 ">
            ...
            <AboutUsCard
              ...
              title="Our Team"
              text="
CapitalRevo boasts a team of highly experienced financial professionals, analysts, and support staff, all dedicated to helping traders succeed. We work continuously to improve our services, ensuring that each trader has access to market-leading resources.
