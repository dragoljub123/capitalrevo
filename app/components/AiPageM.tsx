...
const AiPageM = () => {
  return (
    <div className="mx-auto p-10 text-white">
      ...
      <div className="mb-4">
        <p className="text-xs">
          Simply sign up, deposit your funds, and let CapitalRevo's AI handle
          the heavy lifting—automating analysis, risk management, and trade
      ...
      <div className="mb-4">
        <p className="text-xs">
          With AI in charge, you'll act on emerging opportunities in real-time,
          tapping into the trillions of dollars traded daily on this highly
          liquid market.
        </p>
      </div>
      ...
      <p className="mb-4 text-xs">
        ...
        <br />
        CapitalRevo's AI-driven bot is built with groundbreaking deep learning
        technology, delivering an exceptional trade win rate. Our proprietary
        blend of machine learning and natural language processing models sets a
        new standard in the evolution of AI-powered trading.
      </p>

      <p className="mb-4 text-xs">
        <strong>AI That Thinks Like You</strong>
        <br />
        Harnessing the latest deep neural networks, CapitalRevo's AI algorithms
        mimic the human brain, continuously learning from trades, user behavior,
        and vast datasets. This allows it to anticipate market movements with
      ...
      <p className="mb-4 text-xs">
        ...
        <br />
        With the ability to process massive datasets, CapitalRevo's AI scours
        both traditional and alternative data sources from around the globe.
        Whether it's economic trends or specific asset-class insights, our AI
        forex bot analyzes it all to deliver smarter, faster trades.
      </p>

      <p className="mb-4 text-xs">
        <strong>Mastering Risk Management</strong>
        <br />
        Our AI doesn't just trade—it protects. Using sophisticated mathematical
        models, the system continuously refines risk parameters, balancing
        potential gains with effective risk mitigation. The result? Optimized
        profits with minimized exposure.
      </p>
